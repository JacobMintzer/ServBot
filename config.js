module.exports = {
  ...
  // i.e: "-servbot foo" will trigger the command "foo",
  //      whereas "ServBot foo" will do nothing at all.
  prefix:  "-servbot",

  // Your bot's user token. If you don't know what that is, go here:
  // https://discordapp.com/developers/applications/me
  // Then create a new application and grab your token.
  token: "Mjg0Mzk0MjA0MDEwOTA1NjAw.C5C-bw.nbVrgolCHdNzXvu28XD5cc3VYLI",
